  ...
  return (
    <View>
        ...
        <View style={TopNavbarStyle.container}>
          ...
          <Menu
            visible={visible}
            anchor={<Text onPress={showMenu} style={TopNavbarStyle.kababMenu}>...</Text>}
...
// Icons made by <a href="https://www.flaticon.com/authors/kirill-kazachek" title="Kirill Kazachek">Kirill Kazachek</a> from <a href="https://www.flaticon.com/" title="Flaticon">www.flaticon.com