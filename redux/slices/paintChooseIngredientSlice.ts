import { PaintChooseIngredientState, PaintChooseIngredientTypes } from '../types/paintChooseIngredientTypes';
...
const paintChooseIngredientSlice = createSlice({
  ...
  reducers: {
    paintIngredient: (state: PaintChooseIngredientState, action: Action) => {
        const changeIsPressed: PaintChooseIngredientTypes = action.payload;
        return {
            ...state,
            ingredientsArray: [action.payload]
        };
    },
  },
});
